...
TEST_1:printf("\nWELCOME TO SPARSE MATRIX OPERATIONS DEMO!\n");
    printf("===============================================================\n");
    printf("What is a Sparse Matrix?\n");
    printf("   A sparse matrix is a matrix where most elements are zero.\n");
    printf("   Instead of storing ALL elements (including zeros), we only\n");
    printf("   store the NON-ZERO elements with their positions!\n");
    printf("===============================================================\n\n");
    
    printf("Loading: scrambled_rows.txt (rows in random order)\n");
    sp_tuples * unscrambledrowst = load_tuples("matrices/input_mats/scrambled_rows.txt");
    printt(unscrambledrowst);
    
    printf("Loading: scrambled_rows_large.txt (bigger matrix!)\n");
    sp_tuples * unscrambledrowstlarge = load_tuples("matrices/input_mats/scrambled_rows_large.txt");
    printt(unscrambledrowstlarge);
    
    printf("Loading: withZeroes.txt (matrix with explicit zeros)\n");
    ...
    printf("MATRIX ADDITION DEMO: a_A + a_B\n");
    printf("---------------------------------------------------------------\n");
    printf("Matrix A:\n");
    printt(a_At);
    printf("Matrix B:\n");
    ...
    printf("SPARSE MATRIX ADDITION: sa_A + sa_B\n");
    printf("---------------------------------------------------------------\n");
    ...
    printf("LARGE SPARSE MATRIX ADDITION: sla_A + sla_B\n");
    printf("---------------------------------------------------------------\n");
    printf("This demonstrates the power of sparse matrices with large data!\n");
